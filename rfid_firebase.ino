...
#define FIREBASE_HOST "xxxxxxxxxxx.firebaseio.com" // colocar o nome do host
#define FIREBASE_AUTH "fdfsfedfgdwewefe" // adicionar a chave 
// Definição de usuario e senha da rede WIFI
#define WIFI_SSID "OBS"
#define WIFI_PASSWORD "otaviobelfort"
